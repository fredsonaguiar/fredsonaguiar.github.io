...
In 2025, I obtained a Master's degree in Applied Mathematics and Data Science at the School of Applied Mathematics of Getulio Vargas Foundation (Brazil), carrying out studies on Optimal Control Theory. My main were Mathematical Epidemiology and Machine Learning. See my [Master's Monograph on Learning-Based MPC for Epidemic Mitigation under Uncertainty](https://repositorio.fgv.br/items/5c314745-cc9d-4ec0-9c16-106e9f7fdfe6). See also my [Review Essay on Optimal Control for Safe Reinforcement Learning](https://fredsonaguiar.github.io/assets/pdf/OC_AI_Safety_Overview_Essay.pdf) and my [Case Study on IOC and MPC for Adaptive Autonomous Moving](https://fredsonaguiar.github.io/assets/pdf/IOC_MPC_Timely_Distributional_Change.pdf) for a sample idea of the area.
